...
// (findImageModel + the diffusion sidecar launch were removed in PR E — image gen
// is a BYOK cloud call via phase2-mcp/imagegen_server.py; research/odysseus is gone.)
