      ...
      <div className="max-h-[88vh] w-[560px] max-w-[94vw] overflow-y-auto rounded-xl border border-nightjar-surface bg-nightjar-base shadow-2xl">
        ...
        <div className="space-y-4 px-5 py-4">
          ...
          <p className="rounded-md bg-nightjar-surface/60 p-3 text-xs leading-relaxed text-nightjar-text/80">
            JUNE is <b>cloud-first and quality-first</b>. Speech recognition and Memory storage still run locally
            during the transition, but local inference is not the long-term quality target. An Online chat model
            receives voice transcripts and any Memory context used in that chat. Data for a capability you set{" "}
            <b>Online</b> <b className="text-nightjar-alert">leaves your machine</b>. Future cloud Voice may transmit
            post-wake audio; future cloud Memory may process conversation history, personal context, embeddings,
            summaries, or retrieved memories. Providers and retention policy are not decided yet.
          </p>
