...
// 10) image backend selection moved to Python in PR E (Odysseus removal):
//     phase2-mcp/imagegen_backend.py resolves NIGHTJAR_IMAGE_PROVIDER + BYOK key,
//     and tests/test_imagegen_backend.py carries the precedence/explicitness
//     assertions that lived here (key-alone-never-routes, explicit-only, offline→none).
